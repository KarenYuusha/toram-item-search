...
if example_query is not None:
    st.session_state.query=example_query; st.session_state.item_limit=20; st.session_state.skill_limit=20; st.rerun()
...
if outcome is not None:
    ...
    if outcome.items is not None:
        ...
        if item_fill is not None:
            st.session_state.query=item_fill; st.session_state.item_limit=20; st.session_state.skill_limit=20; st.rerun()
    ...
    if outcome.skills is not None:
        ...
        if skill_fill is not None:
            st.session_state.query=skill_fill; st.session_state.item_limit=20; st.session_state.skill_limit=20; st.rerun()
