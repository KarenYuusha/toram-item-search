window.Streamlit = (function () {
  ...
  function onMessageEvent(event) {
    ...
    events.dispatchEvent(new CustomEvent(RENDER_EVENT, {
      detail: {
  ...
  function setFrameHeight(height) {
    ...
    if (nextHeight === lastFrameHeight) return;
  ...
  return { RENDER_EVENT, events, setComponentReady, setFrameHeight, setComponentValue };
}());
